...
- **Short Window (256 samples):** Provides excellent **time resolution**, meaning we can clearly see exactly *when* transient sounds (like drum hits) occur. However, it suffers from poor frequency resolution, making harmonic bands appear blurry.
- **Long Window (4096 samples):** Provides excellent **frequency resolution**, revealing steady horizontal harmonic bands and individual notes clearly. However, it suffers from poor time resolution, making the exact start and end times of notes blurry.
...
**Live App Link:** [Insert Your Streamlit Cloud Link Here]
**Source Code:** Included in the attached `Q3_submission.zip` file.
